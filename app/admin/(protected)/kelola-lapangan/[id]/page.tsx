...
import { adminCourtCostingQueryOptionsById, adminCourtQueryOptions } from '@/queries/admin/court';
...
const EditCourtPage = async ({ params }) => {
  ...
  await queryClient.prefetchQuery(adminCourtCostingQueryOptionsById(param.id));
