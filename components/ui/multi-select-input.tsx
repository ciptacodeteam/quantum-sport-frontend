...
export interface MultiSelectInputRef {
...
const MultiSelectInput = React.forwardRef<MultiSelectInputRef, MultiSelectInputProps>(
  (
    {
      value,
      onChange,
    ...
    ref: React.Ref<MultiSelectInputRef>
  ) => {
